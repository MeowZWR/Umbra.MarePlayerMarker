...
public static class LocalizationManager
{
    ...
    private static void LoadTranslations()
    {
        ...
        var zhTranslations = new Dictionary<string, string>
        {
            ...
            ["Config.HideIfEmpty.Description"] = "如果当前没有通过Lightless同步的玩家，隐藏组件。",
            ...
            ["Widget.Name"] = "Lightless同步玩家组件",
            ["Widget.Description"] = "提供一个清单显示通过Lightless与你同步的玩家。",
            
            // Player marker 相关翻译
            ["Marker.Name"] = "Lightless同步玩家标记",
            ["Marker.Description"] = "显示通过Lightless与你同步的玩家的世界标记。",
        ...
        var enTranslations = new Dictionary<string, string>
        {
            ...
            ["Config.HideIfEmpty.Description"] = "Hide the widget when there are no players synced through Lightless.",
            ...
            ["Widget.Name"] = "Lightless Synced Players Widget",
            ["Widget.Description"] = "Provides a list showing players synced with you through Lightless.",
            
            // Player marker 相关翻译
            ["Marker.Name"] = "Lightless Synced Players Marker",
            ["Marker.Description"] = "Shows world markers for players synced with you through Lightless.",
