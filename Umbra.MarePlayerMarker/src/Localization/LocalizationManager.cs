...
public static class LocalizationManager
{
    ...
    private static void LoadTranslations()
    {
        ...
        var zhTranslations = new Dictionary<string, string>
        {
            ...
            ["Marker.Config.ShowUid.Name"] = "显示UID",
            ["Marker.Config.ShowUid.Description"] = "在世界标记上显示玩家的游戏UID。",
        ...
        var enTranslations = new Dictionary<string, string>
        {
            ...
            ["Marker.Config.ShowUid.Name"] = "Show UID",
            ["Marker.Config.ShowUid.Description"] = "Display the player's game UID on the world marker.",
